        ...
        <Box display="flex" flexDirection="column" flex={1}>
            ...
            <Box p={3}>
                <Box display="flex" gap={2} flexWrap="wrap" mb={3}>
                    <Card title="Total Users"    value={usrLoading ? "…" : users.length} />
                    <Card title="Active Users"   value={usrLoading ? "…" : users.length}  type="active" />
                    <Card title="Open Incidents" value={incLoading ? "…" : openIncidents} type="inactive" />
                    <Card title="Resolved"       value={incLoading ? "…" : resolved}      type="active" />
                </Box>
