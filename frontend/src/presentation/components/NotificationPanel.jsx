import {
    ...
    CircularProgress, ClickAwayListener, Tooltip, Portal
} from "@mui/material";
        ...
        >
            <Stack direction="row" spacing={1.5} alignItems="flex-start">
                <Box sx={{
                    ...
                    bgcolor: `${accent}15`, border: `1px solid ${accent}28`,
...
export default function NotificationPanel({ notifications, loading, unreadCount, onRead, onReadAll, onClose }) {
    return (
        ...
        // completely outside the hero's overflow:hidden container
        <Portal>
            <ClickAwayListener onClickAway={onClose}>
                <Box sx={{
                    position: "fixed",
                    top: 70,        // distance from top of viewport (below navbar)
                    right: 16,      // distance from right edge
                    width: 320,
                    bgcolor: "rgba(6, 14, 34, 0.92)",
                    ...
                    {/* Header */}
                    <Stack direction="row" justifyContent="space-between" alignItems="center" px={2} py={1.6}>
                        <Stack direction="row" spacing={1} alignItems="center">
                            <Box sx={{
                                width: 28, height: 28, borderRadius: "8px",
                                bgcolor: "rgba(37,99,235,0.15)", border: "1px solid rgba(37,99,235,0.25)",
                                display: "flex", alignItems: "center", justifyContent: "center",
                            }}>
                            ...
                            {unreadCount > 0 && (
                                <Box sx={{
                                    ...
                                    fontSize: 10, fontWeight: 700, px: 0.7, py: 0.1,
                                    lineHeight: 1.7, minWidth: 18, textAlign: "center",
                                }}>
                                    {unreadCount}
                                </Box>
                            )}
                        ...
                        {unreadCount > 0 && (
                            <Tooltip title="Mark all as read">
                                <IconButton size="small" onClick={onReadAll} sx={{
                    ...
                    {notifications.length > 0 && (
                        <>
                            ...
                            <Box px={2} py={1.2} textAlign="center">
                                <Typography sx={{
                                    fontSize: 11, color: "rgba(37,99,235,0.7)", cursor: "pointer",
                                    "&:hover": { color: "#2563eb" }, transition: "color 0.15s ease", fontWeight: 500,
                                }}>
